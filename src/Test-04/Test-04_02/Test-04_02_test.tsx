import {CityType, demolishHousesOnTheStreet, getBuildingsWithStaffCountGreaterThen} from "./Test-04_02";
...
test(' Test 1 House should be destroyed', () => {
...
test('Test 2 buildings with correct staff count', () => {
